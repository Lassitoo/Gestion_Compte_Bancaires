...
try {
    ...
    if (isset($_POST['id_client']) && isset($_POST['numero_compte']) && isset($_POST['montant_retrait'])&& isset($_POST['type_operation']))
    {
            ...
            if($compte_bancaire['solde'] >= $montant_retrait){
            $nouveau_solde = $compte_bancaire['solde'] - $montant_retrait;
            ...
            $stmt->bindParam(':montant', $montant_retrait);
            ...
            exit();
                ...
                header("Location: agent_profil.php?id=$id_client&Ops=$type_operation&errorSolde=$error");
        ...
        <body>
            <div class="container border-left border-success">
                <h4>Retrait du compte numero:<?php echo $numero_compte; ?></h4>
                <form action="retrait.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="montant_retrait">Montant retrait</label>
                        <input class="form-control" type="number" name="montant_retrait" id="montant_retrait" required>
                    </div>
